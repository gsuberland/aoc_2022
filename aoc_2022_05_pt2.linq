...
// perform the moves
// this is the most trivial conversion from the pt1 code, but it's not the most efficient approach
foreach (var move in moves)
{
	var removed = new List<char>();
	// pull the crates off into a list
	for (int n = 0; n < move.Count; n++)
		removed.Add(crateStacks[move.From].Pop());
	// reverse the list
	removed.Reverse();
	// push it back on
	for (int n = 0; n < move.Count; n++)
		crateStacks[move.To].Push(removed[n]);
}
